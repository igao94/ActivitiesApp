    ...
    public MappingProfiles()
    {
        ...
        CreateMap<ActivityAttendee, AttendeeDto>()
            ...
            .ForMember(dest => dest.Following, opt =>
                opt.MapFrom(src => src.AppUser.Followers.Any(u => u.Observer.UserName == currentUsername)));
        ...
        CreateMap<ActivityAttendee, UserActivityDto>()
            ...
            .ForMember(dest => dest.HostUsername, opt =>
                opt.MapFrom(src => src.Activity.Attendees.FirstOrDefault(aa => aa.IsHost)!.AppUser.UserName));
    }
}
